...
// f32 reduce_f32array(i64 size, f32* a) {
//     #if defined(AVX)
//         __m256 r = _mm256_loadu_ps(a);

//         for(i32 i=8; i<size; i+=8)
...
// i32 reduce_i32array(unsigned size, i32* a) {
//     #if defined(AVX)
...
// void add_f32array(unsigned size, f32* a, f32* b, f32* c) {
//     #if defined(AVX)
...
// void add_i32array(unsigned size, i32* a, i32* b, i32* c) {
//     #if defined(AVX)
//         for(i32 i=0; i<size; i+=8) {
...
// void sub_f32array(unsigned size, f32* a, f32* b, f32* c) {
//     #if defined(AVX)
//         for(i32 i=0; i<size; i+=8) {
//             __m256 v0 = _mm256_loadu_ps(&a[i]);
//             __m256 v1 = _mm256_loadu_ps(&b[i]);
...
// void sub_i32array(unsigned size, i32* a, i32* b, i32* c) {
//     #if defined(AVX)
//         for(i32 i=0; i<size; i+=8) {
...
// void mul_f32array(unsigned size, f32* a, f32* b, f32* c) {
//     #if defined(AVX)
//         for(i32 i=0; i<size; i+=8) {
//             __m256 v0 = _mm256_loadu_ps(&a[i]);
//             __m256 v1 = _mm256_loadu_ps(&b[i]);
...
// void mul_i32array(unsigned size, i32* a, i32* b, i32* c) {
//     #if defined(AVX)
//         for(i32 i=0; i<size; i+=8) {
//             __m256i v0 = _mm256_loadu_si256((__m256i*) &a[0]);
//             __m256i v1 = _mm256_loadu_si256((__m256i*) &b[0]);
...
// void div_f32array(unsigned size, f32* a, f32* b, f32* c) {
//     #if defined(AVX)
//         for(i32 i=0; i<size; i+=8) {
//             __m256 v0 = _mm256_loadu_ps(&a[i]);
//             __m256 v1 = _mm256_loadu_ps(&b[i]);
...
// void fma_f32array(unsigned size, f32* a, f32* b, f32* c, f32* d) {
//     #if defined(FMA_AVX)
//         for(i32 i=0; i<size; i+=8) {
//             __m256 v0 = _mm256_loadu_ps(&a[i]);
//             __m256 v1 = _mm256_loadu_ps(&b[i]);
...
// void fma_i32array(unsigned size, i32* a, i32* b, i32* c, i32* d) {
...
// float dot_f32array(unsigned size, f32* a, f32* b) {
...
// void sqrt_f32array(unsigned size, f32* a, f32* c) {
//     #if defined(AVX)
//         for(i32 i=0; i<size; i+=8) {
//             __m256 v0 = _mm256_loadu_ps(&a[i]);
...
#error TODO: MOVE ABOVE TO TENSOR.H
